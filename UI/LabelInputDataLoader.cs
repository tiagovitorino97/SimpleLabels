...
namespace SimpleLabels.UI
{
    ...
    {
        public static void LoadLabelData(string entityGuid, GameObject entityGameObject, GameObject inputGameObject)
        {
            ...
            try
            {
                ...
                LabelTracker.TrackEntity(
                    ...
                    entityData?.FontSize ?? ModSettings.FontDefaultSize.Value,
